const Skills = () => {
    return (
        <section class="text-gray-400 bg-gray-900 body-font" id="skills">
            <div class="container px-5 py-24 mx-auto">
                ...
                <div class="flex flex-wrap lg:w-4/5 sm:mx-auto sm:mb-2 -mx-2">
                    ...
                    <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        class="flex mx-auto items-center text-white bg-green-500 border-0 py-2 px-4 focus:outline-none hover:bg-green-600 rounded text-base mt-16"
                    >
                        Github
                        <svg
                            fill="none"
