import img1 from '../assets/images/details/travel/img1.jpeg';
import img2 from '../assets/images/details/travel/img2.jpeg';
import img3 from '../assets/images/details/travel/img3.jpeg';
import img4 from '../assets/images/details/travel/img4.jpeg';
...
const product = {
  ...
  description:
    '🌍 Travel Now is a travel website. Where people can select destination & book them. Manage the bookings. And all the stuff.',
  highlights: [
    'Firebase authentication',
    'User can explore destinations, book a destination',
    'User can add a destination, can manage bookings',
    'Responsive Website',
    'Error Messages',
  ],
};
          ...
          <div className="py-10 lg:pt-6 lg:pb-16 lg:col-start-1 lg:col-span-2 lg:border-r lg:border-gray-300 lg:pr-8">
            ...
            <div className="mt-10">
              ...
              <div className="mt-4 space-y-4 flex flex-col">
                ...
                <a
                  className="font-bold text-md text-green-500 underline"
                  href="https://github.com/c0der-himel/travel-now-server"
                  target="_blank"
                  rel="noreferrer"
                >
                  Github Back-End
